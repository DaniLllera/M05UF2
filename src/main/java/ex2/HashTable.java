...
public class HashTable {
    ...
    private int getHash(String key) {
        ...
        //key.hascode() coje el key que le pasas con el put genera
        // un integer y se realiza el calculo de ese integer modulo de size que
        // seria 16 dando el resultado 2
    }
